...
const Map = ({ customiseTripModal, accordianData, personaliseTripModal }) => {
 ...
 const accordianPositions = Object.entries(accordianData).map((item, index) => {
  ...
  return (
    <div>
      <div className="h-2/5">
        <button title="Click here to customize your trip with excluding attractions or time"  onClick={(e) => { customiseTripModal(e) }} className="w-full h-1/4 bg-gradient-to-r from-purple-500 to-purple-600 p-2 mb-2 flex items-center justify-center text-white rounded transition duration-300 hover:bg-gradient-to-r hover:from-purple-600 hover:to-purple-800 shadow-lg shadow-slate-700">
          <span className="mr-2">🌐</span>Customise Trip
        </button>
        <button title="Write your preference and regenerate your travel plan as you wish!" onClick={(e) => { personaliseTripModal(e)} } className="w-full h-1/4 bg-gradient-to-r from-purple-600 to-purple-500 p-2 mb-2 flex items-center justify-center text-white rounded transition duration-300 hover:bg-gradient-to-r hover:from-purple-800 hover:to-purple-600 shadow-lg shadow-slate-700">
        ...
        <Link href={"/storytelling.html"} target="_blank">
          <button  title="24X7 Travel Bot for any Assistance."  className="w-full h-1/4 bg-gradient-to-r from-purple-600 to-purple-500 p-2 flex items-center justify-center text-white rounded transition duration-300 hover:bg-gradient-to-r hover:from-purple-800 hover:to-purple-600 shadow-lg shadow-slate-700">
